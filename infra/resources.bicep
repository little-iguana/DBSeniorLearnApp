...
resource keyVault 'Microsoft.KeyVault/vaults@2022-07-01' = {
  ...
  properties: {
    ...
    publicNetworkAccess: 'Enabled' // To see the secret in the portal, change to 'Enabled' 
    networkAcls: {
      defaultAction: 'Allow' // To see the secret in the portal, change to 'Allow' 
      bypass: 'None' 
    }
  }
}
...
resource web 'Microsoft.Web/sites@2022-09-01' = {
  ...
  properties: {
    siteConfig: {
      ...
      ftpsState: 'Disabled'
      appCommandLine: './identitymigrationsbundle -- --environment Production && ./migrationsbundle -- --environment Production && dotnet "DBSeniorLearnApp.UI.dll"'
    }
